 ...
 * generated in the com.mohit.ws.trainings package. 
...
public class ObjectFactory {
    ...
    private final static QName _CreateOrdersRequest_QNAME = new QName("http://trainings.ws.mohit.com/", "createOrdersRequest");
    private final static QName _GetOrdersResponse_QNAME = new QName("http://trainings.ws.mohit.com/", "getOrdersResponse");
    private final static QName _GetOrdersRequest_QNAME = new QName("http://trainings.ws.mohit.com/", "getOrdersRequest");
    private final static QName _CreateOrdersResponse_QNAME = new QName("http://trainings.ws.mohit.com/", "createOrdersResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mohit.ws.trainings
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.mohit.com/", name = "createOrdersRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.mohit.com/", name = "getOrdersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.mohit.com/", name = "getOrdersRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.mohit.com/", name = "createOrdersResponse")
